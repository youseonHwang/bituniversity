...
<body>
  ...
  <!-- ========== MAIN CONTENT ========== -->
  <form action="findId.do" method="post" class="js-validate form-signin p-5">
  <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token }">
    ...
    <div class="text-center mb-4">
      <h1 class="h3 mb-0">학번 찾기</h1>
      <p class="m-0 font-size-13">이름과 입학 시에 작성한 이메일을 입력해주세요</p>
      <p class="m-0 font-size-13">해당 이메일로 학번이 전송됩니다</p>
    </div>
    <!-- End Title -->
    ...
    <div class="js-form-message mb-3">
      <div class="js-focus-state input-group form">
        ...
        <input type="text" class="form-control form__input" name="std_name" required
               placeholder="이름"
               aria-label="name"
               data-msg="이름을 입력해주세요"
    ...
    <!-- End Input -->
    <div class = "col-12 text-center text-danger" id="result_id">${result_id }</div>
    <div class="row mb-3">
    ...
    <div class="mb-3">
      <button type="submit" class="btn btn-block btn-primary">학번 찾기</button>
    </div>
