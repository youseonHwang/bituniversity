...
<body>
  ...
  <main id="content">
    ...
    <div class="hanna space-2 space-3-top--lg bg-primary text-white text-center text-weight-bold">
      <h1 class = "h1 hanna">학생 기본정보 관리</h1>
    </div>
    <!-- End Hero Section -->
    ...
    <div class="container space-3-bottom--lg space-2-top">
      <div class="row">
        <div class="col-lg-9 order-lg-2 mb-9 mb-lg-0">
          <form class="js-validate" method="post" enctype="multipart/form-data" id="insertForm">
          <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token }">
                ...
                <div class="js-form-message">
                  ...
                  <div class="js-focus-state input-group form">
                    <input class="form-control form__input" type="number" name="std_no" required
                           ...
                           aria-label=""
                           data-msg="Please enter your student number."
                ...
                <div class="js-form-message">
                  ...
                  <div class="js-focus-state input-group form">
                    <input class="form-control form__input" type="date" name="std_birthday" required
                           ...
                           aria-label=""
                           data-msg="Please enter a valid birthday."
                           data-error-class="u-has-error"
                           data-success-class="u-has-success">
                  </div>
                </div>
                ...
                <div class="js-form-message">
                  ...
                  <div class="js-focus-state input-group form">
                    <input class="form-control form__input" type="text" name="std_status" required
                           placeholder="ex)신입학"
                           aria-label=""
                           data-msg="Please enter a valid status."
                           data-error-class="u-has-error"
                           data-success-class="u-has-success">
                  </div>
                </div>
                ...
                <div class="js-form-message">
                  ...
                  <div class="js-focus-state input-group form">
                    <input class="form-control form__input" type="text" name="std_level" required
                           placeholder="1"
                           aria-label=""
                           data-msg="Please enter a valid level."
                           data-error-class="u-has-error"
                           data-success-class="u-has-success">
                  </div>
                </div>
                ...
                <div class="js-form-message">
                  ...
                  <div class="js-focus-state input-group form">
                    <input class="form-control form__input" type="text" name="std_semester" required
                           placeholder="1"
                           aria-label=""
                           data-msg="Please enter a valid semester."
                           data-error-class="u-has-error"
                           data-success-class="u-has-success">
                  </div>
                </div>
                ...
                <div class="js-form-message">
                  ...
                  <div class="js-focus-state input-group form">
                    <input class="form-control form__input" type="date" name="std_startdate" required
                           placeholder="0000-00-00"
                           aria-label=""
                           data-msg="Please enter a valid startdate."
                           data-error-class="u-has-error"
                           data-success-class="u-has-success">
                  </div>
                </div>
                ...
                <div class="js-form-message">
                  ...
                  <div class="js-focus-state input-group form">
                    <input class="form-control form__input" type="number" name="pro_no" required
                           placeholder="0000"
                           aria-label=""
                           data-msg="Please enter a valid pro number."
                           data-error-class="u-has-error"
                           data-success-class="u-has-success">
                  </div>
                </div>
                ...
                <div class="js-form-message">
                  ...
                  <div class="js-focus-state input-group form">
                    <input class="form-control form__input" type="text"" name="std_gender" required
                           placeholder="ex)남, 여"
                           aria-label=""
                           data-msg="Please enter a valid gender."
                           data-error-class="u-has-error"
                           data-success-class="u-has-success">
                  </div>
                </div>
            ...
            <div class="js-form-message mb-5">
              ...
              <div class="js-focus-state input-group form">
                <textarea class="form-control form__input" rows="4" name="std_etc" required
                          placeholder="..."
                          aria-label=""
            ...
            <div class="text-center">
              <button type="button" class="btn btn-primary btn-wide mb-4" id="btnAdd">등록</button>
            </div>
          </form>
